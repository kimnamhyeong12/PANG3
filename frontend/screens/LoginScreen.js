  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
      ...
      <View style={styles.loginArea}>
        ...
        <PrimaryButton title={loading ? '인증 중...' : '로그인'} onPress={login} disabled={!id || !pw || loading} />

        <View style={styles.notice}>
          <Text style={styles.noticeText}>본 시스템은 사하구청 외근 담당자 전용 시스템입니다. 모든 접속 기록은 보안 정책에 따라 저장됩니다.</Text>
        </View>
      </View>
