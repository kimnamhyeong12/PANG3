...
export default function MainScreen({
  ...
  onSettings, locations = [], setLocations, onRefreshAssignments,
}) {
    ...
    <>
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.topBar}>
          <View style={styles.brandRow}><View style={styles.brandMark}><Ionicons name="navigate" size={18} color="#FFFFFF" /></View><Text style={styles.brand}>외근도우미</Text></View>
          <TouchableOpacity style={styles.iconButton} onPress={onSettings || onDashboard}><Ionicons name="settings-outline" size={21} color={colors.text} /></TouchableOpacity>
        </View>
        ...
        <View style={styles.quickGrid}>
          <QuickAction icon="map-outline" label="경로 확인" onPress={onRoute} />
          <QuickAction icon="document-text-outline" label="보고서" onPress={onReport} />
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: colors.background }, content: { padding: 20, paddingBottom: 36 },
  topBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, brandRow: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  brandMark: { width: 34, height: 34, borderRadius: 11, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' }, brand: { color: colors.text, fontSize: 20, fontWeight: '900' },
  iconButton: { width: 42, height: 42, borderRadius: 14, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center' },
  userRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 30 }, date: { color: colors.textSoft, fontSize: 12, fontWeight: '700' }, userName: { color: colors.text, fontSize: 28, fontWeight: '900', marginTop: 4 }, region: { color: colors.primary, fontSize: 11, marginTop: 6, fontWeight: '800' },
  avatar: { width: 52, height: 52, borderRadius: 18, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' }, avatarText: { color: colors.primary, fontSize: 20, fontWeight: '900' },
  workspace: { marginTop: 20, borderRadius: radius.large, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 10 }, workspaceIcon: { width: 40, height: 40, borderRadius: 13, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' }, workspaceLabel: { color: colors.textSoft, fontSize: 9 }, workspaceName: { color: colors.text, fontSize: 14, fontWeight: '900', marginTop: 2 }, roleBadge: { backgroundColor: colors.surfaceMuted, paddingHorizontal: 9, paddingVertical: 5, borderRadius: 999 }, roleText: { color: colors.primary, fontSize: 10, fontWeight: '900' },
  summaryCard: { marginTop: 14, borderRadius: radius.large, backgroundColor: colors.primaryDark, padding: 18, ...shadow }, summaryHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, summaryTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '900' }, summarySub: { color: '#BFD8CE', fontSize: 11, marginTop: 4 }, progressText: { color: '#FFFFFF', fontSize: 26, fontWeight: '900' }, progressTrack: { height: 7, backgroundColor: 'rgba(255,255,255,0.18)', borderRadius: 999, overflow: 'hidden', marginTop: 15 }, progressFill: { height: '100%', backgroundColor: '#7DD3B0', borderRadius: 999 }, metrics: { flexDirection: 'row', marginTop: 18 }, metric: { flex: 1, alignItems: 'center' }, metricValue: { fontSize: 21, fontWeight: '900' }, metricLabel: { color: '#C8DDD4', fontSize: 10, marginTop: 3 },
  quickGrid: { flexDirection: 'row', gap: 8, marginTop: 14, marginBottom: 26 }, quickAction: { flex: 1, minHeight: 78, borderRadius: radius.medium, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center', gap: 7 }, quickIcon: { width: 34, height: 34, borderRadius: 11, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' }, quickLabel: { color: colors.text, fontSize: 10, fontWeight: '800' },
  ...
  sectionGap: { marginTop: 26 }, listCard: { backgroundColor: colors.surface, borderRadius: radius.large, borderWidth: 1, borderColor: colors.line, overflow: 'hidden' }, overdueRow: { flexDirection: 'row', alignItems: 'center', gap: 11, padding: 15 }, rowBorder: { borderTopWidth: 1, borderTopColor: colors.line }, checkbox: { width: 24, height: 24, borderRadius: 8, borderWidth: 2, borderColor: '#B8C5BE', alignItems: 'center', justifyContent: 'center' }, checkboxActive: { backgroundColor: colors.primary, borderColor: colors.primary }, metaRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginBottom: 7 }, dateChip: { fontSize: 9, color: colors.primary, fontWeight: '900', backgroundColor: colors.primarySoft, paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999 }, categoryChip: { fontSize: 9, color: colors.textSoft, fontWeight: '800', backgroundColor: colors.surfaceMuted, paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999 }, statusChip: { fontSize: 9, color: colors.pending, fontWeight: '900' }, workingChip: { color: colors.warning }, rowTitle: { color: colors.text, fontSize: 13, fontWeight: '900' }, rowSub: { color: colors.textSoft, fontSize: 10, marginTop: 3 }, deleteButton: { width: 36, height: 36, alignItems: 'center', justifyContent: 'center' }, moveButton: { minHeight: 48, backgroundColor: colors.primary, margin: 12, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, moveDisabled: { backgroundColor: '#BBC6C0' }, moveText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
