...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {screen === 'login' && <LoginScreen onLogin={() => go('main')} />}
      {screen === 'main' && (
        <MainScreen
      ...
      {screen === 'dashboard' && <DashboardScreen onBack={() => go('main')} />}
      {screen === 'mapDirect' && (
        <MapScreen
      ...
      {screen === 'report' && <ReportScreen onBack={() => go('main')} onDownload={() => go('download')} />}
